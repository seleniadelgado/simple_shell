...
/**
 * @path: parameter passed in that will be parsed.
 * @head: second parameter passed in that will also be parsed through the func.
 */
 ...
 * @head: a pointer to the first node which will be freed aling with the rest.
  * Return: nothing
 */
